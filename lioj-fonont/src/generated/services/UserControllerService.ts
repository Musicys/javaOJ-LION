...
import type { BaseResponse_DtoUser_ } from '../models/BaseResponse_DtoUser_';
...
export class UserControllerService {
     ...
     * getDtoUserById
     * @param id id
     * @returns BaseResponse_DtoUser_ OK
     * @throws ApiError
     */
    public static getDtoUserByIdUsingGet(
        id?: number,
    ): CancelablePromise<BaseResponse_DtoUser_> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/user/get/messge',
            query: {
                'id': id,
            },
            errors: {
